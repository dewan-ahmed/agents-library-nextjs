...
import { ownershipLabel, useCasesOf, yamlForPipeline, type Agent, type Pipeline } from "@/lib/catalog";
import { CopyButton } from "./YamlBlock";
import { ConfigSummary } from "./ConfigChecklist";
import { applyYamlScope, emptyScope, type HarnessScope } from "@/lib/scope";
