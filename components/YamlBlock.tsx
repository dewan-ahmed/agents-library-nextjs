...
function CopyGlyph() {
  return (
    <svg width="15" height="15" viewBox="0 0 16 16" fill="none" aria-hidden="true">
      ...
      <path d="M10.25 3.75V3.5A1.75 1.75 0 0 0 8.5 1.75h-5A1.75 1.75 0 0 0 1.75 3.5v5c0 .966.784 1.75 1.75 1.75h.25" stroke="currentColor" strokeWidth="1.3" strokeLinecap="round" />
    </svg>
  );
}
...
function CheckGlyph() {
  return (
    <svg width="15" height="15" viewBox="0 0 16 16" fill="none" aria-hidden="true">
      <path d="M3 8.5l3.25 3.25L13 5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
